...
module.exports = {
  ...
  safelist: [
    ...
    {
      pattern: /content-(left|right|center)_(top|bottom)/,
      variants: ['xxl', 'xl', 'lg', 'md',],
    },
    {
      pattern: /content-(left|right|center|top|bottom)/,
      variants: ['xxl', 'xl', 'lg', 'md',],
    },
    {
      pattern: /object-position-(left|right|center)-(top|bottom)/,
      variants: ['xxl', 'xl', 'lg', 'md',],
    },
    {
      pattern: /object-position-(left|right|center|top|bottom)/,
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'arizona-16': ['16px', { lineHeight: '1.1', letterSpacing: '0', }],
        'arizona-12': ['12px', { lineHeight: '1.1', letterSpacing: '0', }],
        //custom
